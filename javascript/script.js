...
function updateTimer() {
  const targetDate = new Date("march 28, 2026 21:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '543815695647'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '543815695647'; // Número para el primer botón
  const recipientNumber2 = '543814461302'; // Número para el segundo botón
