const CACHE_NAME = 'cache-v21'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v21',
    'estilos/styles.css?v21',
    'estilos/mediaQueries.css?v21',
    'javascript/script.js?v21',
